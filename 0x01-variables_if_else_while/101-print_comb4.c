...
int main(void)
{
	 ...
	 * abc are possible digits
	 */
	int a, b, c;

	/**
	 * loop through a, the first digit,lowest of the 3,
	 * and highest possible is 7
	 */
	for (a = 0 ; a <= 7 ; a++)
	{
		/**
		 * loop through b,2nd digit, higher than a by 1,
		 * highest possible is 8
		 */
		for (b = a + 1 ; b <= 8 ; b++)
		{
			/**
			 * loop through c,third digit,higher than b by 1,
			 * highest possible is 9
			 */
			for (c = b + 1 ; c <= 9 ; c++)
			{
				putchar((a % 10) + '0');
